...
class Builder extends ZBuilder
{
     ...
     * @return mixed
     */
    public function addOssImage($name = '', $title = '', $tips = '', $default = '', $size = '', $ext = '', $extra_class = '', $thumb = '', $watermark = '')
    {
     ...
     * 添加单个视频上传
     */
    public function addOssVideo($name = '', $title = '',$default='')
    {
        ...
        if ($type != '') {
            switch ($type) {
                ...
                case 'image':
                 ...
                 case 'ossvideo':
                 case 'ossimage':
                    $this->_vars['_js_files'][]  = 'aliwebuploader_js';
                    $this->_vars['_css_files'][] = 'webuploader_css';
                    break;    
                case 'icon':
                    $this->_vars['_icon'] = '1';
